...
/** *** */ }({
  ...
  \************************************* */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		...
		/* harmony import */ const _modeController_MenuModeController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modeController/MenuModeController */ './src/controller/modeController/MenuModeController.js');
		/* harmony import */ const _modeController_TrainModeController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modeController/TrainModeController */ './src/controller/modeController/TrainModeController.js');
		/* harmony import */ const _modeController_PlayModeController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modeController/PlayModeController */ './src/controller/modeController/PlayModeController.js');
		...
		const Controller = /* #__PURE__ */(function () {
			function Controller(view, model) {
				...
				this.view.on('main_page_requested', () => _this.setModeController(true));
				...
				this.view.on('reset_stat_clicked', () => {
			...
			_createClass(Controller, [{
				...
				value: function setModeController() {
					...
					const isMenu = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
					...
					if (isMenu) {
						...
						if (this.model.mode === 'play') {
							...
							this.modeController.on('main_page_requested', () => _this2.setModeController(true));
						}
					}
  ...
  \************************************************************ */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ const _ModeController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ModeController */ './src/controller/modeController/ModeController.js');
		...
		const MenuModeController = /* #__PURE__ */(function (_ModeController) {
			_inherits(MenuModeController, _ModeController);

			const _super = _createSuper(MenuModeController);
  ...
  \******************************************************** */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		...
		const ModeController = /* #__PURE__ */(function () {
  ...
  \************************************************************ */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		...
		const PlayModeController = /* #__PURE__ */(function (_ModeController) {
			_inherits(PlayModeController, _ModeController);

			const _super = _createSuper(PlayModeController);
  ...
  \************************************************************* */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		...
		const TrainModeController = /* #__PURE__ */(function (_ModeController) {
			_inherits(TrainModeController, _ModeController);

			const _super = _createSuper(TrainModeController);
  ...
  \********************* */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ const _controller_Controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controller/Controller */ './src/controller/Controller.js');
		/* harmony import */ const _view_View__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/View */ './src/view/View.js');
		/* harmony import */ const _model_Model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/Model */ './src/model/Model.js');
  ...
  \************************** */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		...
		const Card = function Card(id, word, translation, img, audioSrc) {
  ...
  \****************************** */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ const _Card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Card.js */ './src/model/Card.js');
		function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
		...
		const Category = /* #__PURE__ */(function () {
  ...
  \*************************** */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ const _Category__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Category */ './src/model/Category.js');
		/* harmony import */ const _mixins_eventMixin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mixins/eventMixin */ './src/mixins/eventMixin.js');
		/* harmony import */ const _Menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Menu */ './src/model/Menu.js');
		/* harmony import */ const _Statistic__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Statistic */ './src/model/Statistic.js');
		/* harmony import */ const _data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../data */ './src/data.js');
		function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  \******************************* */
	...
	/***/ (function (module, __webpack_exports__, __webpack_require__) {
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ const _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data */ './src/data.js');
		...
		const Statistic = /* #__PURE__ */(function () {
			function Statistic() {
			...
			_createClass(Statistic, [{
				...
				value: function getWords() {
					const id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'all';
				...
				value: function setStatistic(id, parameter) {
					const _iterator = _createForOfIteratorHelper(this.words);
					let _step;

					try {
						for (_iterator.s(); !(_step = _iterator.n()).done;) {
							const category = _step.value;
							let flag = false;

							const _iterator2 = _createForOfIteratorHelper(category.words);
							var _step2;

							try {
								for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
									const word = _step2.value;
				...
				value: function createData() {
					const words = _data__WEBPACK_IMPORTED_MODULE_0__.default.map((category) => ({
						id: category.id,
		...
		const View = /* #__PURE__ */(function () {
			...
			_createClass(View, [{
				...
				value: function flipCard(id) {
					...
					const card = this.cardsContainer.querySelector('[data-id="'.concat(id, '"]'));
					card.classList.toggle('is-flipped');
					setTimeout(() => {
						card.addEventListener('mouseleave', _this.leaveCardHandler.bind(_this));
					}, 800);
				},
			}, {
				key: 'playModeView',
				...
				value: function drawScore(roundArray) {
					...
					roundArray.forEach((round) => {
						...
						_this2.scoreContainer.appendChild(star);
					});
				},
			}, {
				key: 'drawCard',
				...
				value: function drawCards(arrayCards) {
					...
					const isArrow = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
					arrayCards.forEach((_ref) => {
						...
						_this3.drawCard(id, word, img, translation, isArrow);
					});
				},
			}, {
				key: 'drowMenuItem',
				...
				value: function drawStatistic(arr) {
					...
					arr.forEach((word) => {
						...
						_this4.statTable.appendChild(tr);
					});
				},
			}, {
				key: 'drowMenu',
				value: function drowMenu(arrayMenu) {
					...
					arrayMenu.items.forEach((link) => {
						_this5.drowMenuItem(link.word, link.id);
					});
				},
			}, {
				key: 'drawButton',
